...
public class ThingsBankActivity extends AppCompatActivity {

    private static String category = "things";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_things_bank);

        // Change Action Bar Title
        View actionBar = findViewById(R.id.actionBar);
        TextView actionBarTitle = actionBar.findViewById(R.id.actionBarTitle);
        actionBarTitle.setText("Things Word Bank");
        ...
        sv = (HorizontalScrollView) findViewById(R.id.thingsHorizontalSV);
