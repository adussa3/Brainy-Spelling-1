...
public class OutdoorsBankActivity extends AppCompatActivity {

    private static String category = "outdoors";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoors_bank);

        // Change Action Bar Title
        View actionBar = findViewById(R.id.actionBar);
        TextView actionBarTitle = actionBar.findViewById(R.id.actionBarTitle);
        actionBarTitle.setText("Outdoors Word Bank");
        ...
        sv = (HorizontalScrollView) findViewById(R.id.outdoorsHorizontalSV);
