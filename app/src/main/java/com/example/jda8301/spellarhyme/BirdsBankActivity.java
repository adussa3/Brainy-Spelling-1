...
public class BirdsBankActivity extends AppCompatActivity {
    private static String category = "birds";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sv = (HorizontalScrollView) findViewById(R.id.birdsHorizontalSV);
