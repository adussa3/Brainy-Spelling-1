...
public class VehiclesBankActivity extends AppCompatActivity {

    private static String category = "vehicles";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicles_bank);

        // Change Action Bar Title
        View actionBar = findViewById(R.id.actionBar);
        TextView actionBarTitle = actionBar.findViewById(R.id.actionBarTitle);
        actionBarTitle.setText("Vehicles Word Bank");
        ...
        sv = (HorizontalScrollView) findViewById(R.id.vehiclesHorizontalSV);
