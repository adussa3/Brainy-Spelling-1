...
public class ToolsBankActivity extends AppCompatActivity {

    private static String category = "tools";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tools_bank);

        // Change Action Bar Title
        View actionBar = findViewById(R.id.actionBar);
        TextView actionBarTitle = actionBar.findViewById(R.id.actionBarTitle);
        actionBarTitle.setText("Tools Word Bank");
        ...
        sv = (HorizontalScrollView) findViewById(R.id.toolsHorizontalSV);
